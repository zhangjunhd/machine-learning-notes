...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with tf.variable_scope("autoencoder_model"):
            ...
            train_writer = tf.summary.FileWriter("pos_tagger=" + str(n_gram) + "-gram_logs/", graph=sess.graph)

            val_writer = tf.summary.FileWriter("pos_tagger=" + str(n_gram) + "-gram_logs/", graph=sess.graph)
            ...
            sentence = ["Then", "the", "woman", ",", "after", "grabbing", "her", "umbrella", ",",
                        "went", "to", "the", "bank", "to", "deposit", "her", "cash", "."]
            test_vectors = []
            if n_gram > 1:
            ...
            for epoch in range(training_epochs):
                ...
                if epoch % display_step == 0:
                    ...
                    accuracy, val_summary = sess.run([eval_op, val_summary_op],
                                                     feed_dict={x: val_x, y: val_y, phase_train: False})
                    ...
                    saver.save(sess, "pos_tagger=" + str(n_gram) + "-gram_logs//model-checkpoint-" + '%04d' % (epoch+1),
